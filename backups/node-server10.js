...
myHTTPServer.listen(myPortNumber, '0.0.0.0', () => {
    console.log(`\n======================================================`);
...
// *** FINAL CODE CHANGE: Explicitly bind the WebSocket server to all interfaces (0.0.0.0) ***
const myServer = new myWebSocket.Server({ server: myHTTPServer, host: '0.0.0.0' });
